...
/**This class create the Modify Part form*/
public class ModifyPartController implements Initializable {
     ...
     * to the Modify Part scene
     * @param selectedPart
     * @param index 
     */
    public void preFillText(Part selectedPart, int index) {
       partIndex = index;
       ...
       if (selectedPart instanceof InHouse) {
           radioBtnInHouse.setSelected(true);
           toggleLabel.setText("Machine ID");
           partToggle.setText(Integer.toString(((InHouse)selectedPart).getMachineId()));
       } else {
           radioBtnOutsourced.setSelected(true);
           toggleLabel.setText("Company Name");
           partToggle.setText(((Outsourced)selectedPart).getCompanyName());
       }
    ...
    private void saveButtonPushed(ActionEvent event) throws IOException {
        ...
        if ("Machine ID".equals(toggleLabel.getText())) {
            ...
            controller.updatePart(partIndex, newPartInHouse);
        }
        else {
            ...
            controller.updatePart(partIndex, newPartOutsourced);
        }
